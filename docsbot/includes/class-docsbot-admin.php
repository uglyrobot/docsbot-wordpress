...
final class DocsBot_Admin {
	...
	private function custom_button_icon_options() {
		...
		$out = array(
			'AcademicCapIcon'            => __( 'Academic Cap', 'docsbot' ),
			'AdjustmentsHorizontalIcon'  => __( 'Adjustments Horizontal', 'docsbot' ),
			'ArchiveBoxIcon'             => __( 'Archive Box', 'docsbot' ),
			'ArrowTrendingUpIcon'        => __( 'Arrow Trending Up', 'docsbot' ),
			'ArrowPathRoundedSquareIcon' => __( 'Arrow Path Rounded Square', 'docsbot' ),
			'AtSymbolIcon'               => __( 'At Symbol', 'docsbot' ),
			'BanknotesIcon'              => __( 'Banknotes', 'docsbot' ),
			'BeakerIcon'                 => __( 'Beaker', 'docsbot' ),
			'BoltIcon'                   => __( 'Bolt', 'docsbot' ),
			'BellIcon'                   => __( 'Bell', 'docsbot' ),
			'BookOpenIcon'               => __( 'Book Open', 'docsbot' ),
			'BookmarkIcon'               => __( 'Bookmark', 'docsbot' ),
			'BriefcaseIcon'              => __( 'Briefcase', 'docsbot' ),
			'BuildingLibraryIcon'        => __( 'Building Library', 'docsbot' ),
			'BuildingOffice2Icon'        => __( 'Building Office2', 'docsbot' ),
			'BuildingStorefrontIcon'     => __( 'Building Storefront', 'docsbot' ),
			'BugAntIcon'                 => __( 'Bug Ant', 'docsbot' ),
			'CakeIcon'                   => __( 'Cake', 'docsbot' ),
			'CalculatorIcon'             => __( 'Calculator', 'docsbot' ),
			'CalendarIcon'               => __( 'Calendar', 'docsbot' ),
			'CameraIcon'                 => __( 'Camera', 'docsbot' ),
			'ChartBarIcon'               => __( 'Chart Bar', 'docsbot' ),
			'ChartPieIcon'               => __( 'Chart Pie', 'docsbot' ),
			'ChatBubbleLeftIcon'         => __( 'Chat Bubble Left', 'docsbot' ),
			'CheckCircleIcon'            => __( 'Check Circle', 'docsbot' ),
			'CloudIcon'                  => __( 'Cloud', 'docsbot' ),
			'ClockIcon'                  => __( 'Clock', 'docsbot' ),
			'CodeBracketIcon'            => __( 'Code Bracket', 'docsbot' ),
			'CogIcon'                    => __( 'Cog', 'docsbot' ),
			'CommandLineIcon'            => __( 'Command Line', 'docsbot' ),
			'ComputerDesktopIcon'        => __( 'Computer Desktop', 'docsbot' ),
			'CpuChipIcon'                => __( 'Cpu Chip', 'docsbot' ),
			'CreditCardIcon'             => __( 'Credit Card', 'docsbot' ),
			'CubeIcon'                   => __( 'Cube', 'docsbot' ),
			'DevicePhoneMobileIcon'      => __( 'Device Phone Mobile', 'docsbot' ),
			'DocumentTextIcon'           => __( 'Document Text', 'docsbot' ),
			'EnvelopeIcon'               => __( 'Envelope', 'docsbot' ),
			'ExclamationCircleIcon'      => __( 'Exclamation Circle', 'docsbot' ),
			'EyeIcon'                    => __( 'Eye', 'docsbot' ),
			'FaceSmileIcon'              => __( 'Face Smile', 'docsbot' ),
			'FilmIcon'                   => __( 'Film', 'docsbot' ),
			'FingerPrintIcon'            => __( 'Finger Print', 'docsbot' ),
			'FireIcon'                   => __( 'Fire', 'docsbot' ),
			'FlagIcon'                   => __( 'Flag', 'docsbot' ),
			'FolderIcon'                 => __( 'Folder', 'docsbot' ),
			'GiftIcon'                   => __( 'Gift', 'docsbot' ),
			'GlobeAltIcon'               => __( 'Globe Alt', 'docsbot' ),
			'GlobeAsiaAustraliaIcon'     => __( 'Globe Asia Australia', 'docsbot' ),
			'HandRaisedIcon'             => __( 'Hand Raised', 'docsbot' ),
			'HashtagIcon'                => __( 'Hashtag', 'docsbot' ),
			'HeartIcon'                  => __( 'Heart', 'docsbot' ),
			'HomeIcon'                   => __( 'Home', 'docsbot' ),
			'HomeModernIcon'             => __( 'Home Modern', 'docsbot' ),
			'IdentificationIcon'         => __( 'Identification', 'docsbot' ),
			'InformationCircleIcon'      => __( 'Information Circle', 'docsbot' ),
			'KeyIcon'                    => __( 'Key', 'docsbot' ),
			'LanguageIcon'               => __( 'Language', 'docsbot' ),
			'LightBulbIcon'              => __( 'Light Bulb', 'docsbot' ),
			'LinkIcon'                   => __( 'Link', 'docsbot' ),
			'ListBulletIcon'             => __( 'List Bullet', 'docsbot' ),
			'LockClosedIcon'             => __( 'Lock Closed', 'docsbot' ),
			'MagnifyingGlassIcon'        => __( 'Magnifying Glass', 'docsbot' ),
			'MapPinIcon'                 => __( 'Map Pin', 'docsbot' ),
			'MegaphoneIcon'              => __( 'Megaphone', 'docsbot' ),
			'MicrophoneIcon'             => __( 'Microphone', 'docsbot' ),
			'MoonIcon'                   => __( 'Moon', 'docsbot' ),
			'NewspaperIcon'              => __( 'Newspaper', 'docsbot' ),
			'PaintBrushIcon'             => __( 'Paint Brush', 'docsbot' ),
			'PaperAirplaneIcon'          => __( 'Paper Airplane', 'docsbot' ),
			'PencilIcon'                 => __( 'Pencil', 'docsbot' ),
			'PhoneIcon'                  => __( 'Phone', 'docsbot' ),
			'PhotoIcon'                  => __( 'Photo', 'docsbot' ),
			'PlayIcon'                   => __( 'Play', 'docsbot' ),
			'PresentationChartBarIcon'   => __( 'Presentation Chart Bar', 'docsbot' ),
			'PrinterIcon'                => __( 'Printer', 'docsbot' ),
			'PuzzlePieceIcon'            => __( 'Puzzle Piece', 'docsbot' ),
			'RadioIcon'                  => __( 'Radio', 'docsbot' ),
			'RectangleGroupIcon'         => __( 'Rectangle Group', 'docsbot' ),
			'RocketLaunchIcon'           => __( 'Rocket Launch', 'docsbot' ),
			'ScaleIcon'                  => __( 'Scale', 'docsbot' ),
			'ScissorsIcon'               => __( 'Scissors', 'docsbot' ),
			'ServerIcon'                 => __( 'Server', 'docsbot' ),
			'ShieldCheckIcon'            => __( 'Shield Check', 'docsbot' ),
			'ShoppingBagIcon'            => __( 'Shopping Bag', 'docsbot' ),
			'ShoppingCartIcon'           => __( 'Shopping Cart', 'docsbot' ),
			'SignalIcon'                 => __( 'Signal', 'docsbot' ),
			'SparklesIcon'               => __( 'Sparkles', 'docsbot' ),
			'SpeakerWaveIcon'            => __( 'Speaker Wave', 'docsbot' ),
			'StarIcon'                   => __( 'Star', 'docsbot' ),
			'SunIcon'                    => __( 'Sun', 'docsbot' ),
			'TicketIcon'                 => __( 'Ticket', 'docsbot' ),
			'TrashIcon'                  => __( 'Trash', 'docsbot' ),
			'TrophyIcon'                 => __( 'Trophy', 'docsbot' ),
			'TruckIcon'                  => __( 'Truck', 'docsbot' ),
			'TvIcon'                     => __( 'Tv', 'docsbot' ),
			'UserCircleIcon'             => __( 'User Circle', 'docsbot' ),
			'UserGroupIcon'              => __( 'User Group', 'docsbot' ),
			'VideoCameraIcon'            => __( 'Video Camera', 'docsbot' ),
			'WalletIcon'                 => __( 'Wallet', 'docsbot' ),
			'WifiIcon'                   => __( 'Wifi', 'docsbot' ),
			'WrenchIcon'                 => __( 'Wrench', 'docsbot' ),
		);
		return $out;
	}
